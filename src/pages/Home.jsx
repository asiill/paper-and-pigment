        ...
        <section id="home" className="p-4">
            <div className="grid grid-cols-2">
                <figure className="col-span-1 relative margin-0">
                    ...
                    <figcaption className="absolute bottom-0 left-0 p-1 bg-neutral-300/[.07] text-xs">Photo by <a href="https://www.pexels.com/@shelaghmurphy/"></a>Shelagh Murphy</figcaption>
                </figure>
